...
urlpatterns = [
    ...
    # For username format, see django.contrib.auth.validators.ASCIIUsernameValidator
    # https://docs.djangoproject.com/en/1.10/ref/contrib/auth/#validators
    url(r'^verify-email/(?P<username>[a-zA-Z0-9]+)/(?P<token>[a-z0-9\-]+)$',
        sn_views.verify_email, name='verify'),
    # View profile
